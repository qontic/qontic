        ...
        {canvasTab === "about" && (
          <div style={{ flex:1, overflowY:"auto", padding:"28px 36px",
            ...
            {[
              ...
              "The Copenhagen interpretation offers two levels of description. Switch to Operator view to see the textbook formalism without the apparatus. Here the measurement device is hidden and replaced by an abstract observable — a mathematical operator whose two possible outcomes are +1 for transmission and −1 for reflection. Before the measurement, the particle is in a superposition of both outcomes. Applying the operator picks one: the branch corresponding to the observed result survives and is renormalised; the other is discarded. The probability of each outcome is set by how much of the wavefunction sits in that branch. Use the Step button to walk through these stages one click at a time.",
